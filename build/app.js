...
var AddImageOffsetsWidget = React.createClass({displayName: "AddImageOffsetsWidget",
    ...
    "render" : function() {
        ...
        return (
            React.createElement("section", {className: "tool-panel__widget offsets-widget"}, 
                React.createElement("div", {className: "tool-panel__header"}, 
                    React.createElement("p", {className: "tool-panel__title"}, "Cropping / Padding")
                ), 
                React.createElement("div", {className: "tool-panel__body"}, 
                    React.createElement("form", {className: "cf"}, 
                        React.createElement("div", {className: "offsets-widget__layout border-box"}, 
                            React.createElement("div", {className: "offsets-widget__layout-inner border-box"}, 
                                React.createElement("input", {type: "text", ref: "top", className: "offsets-widget__layout-input offsets-widget__layout-input--top", onChange: this.handleChange, onKeyDown: this.handleInput, value: this.state.top}), 
                                React.createElement("br", null), 
                                React.createElement("input", {type: "text", ref: "left", className: "offsets-widget__layout-input offsets-widget__layout-input--left", onChange: this.handleChange, onKeyDown: this.handleInput, value: this.state.left}), 
                                React.createElement("div", {className: "offsets-widget__layout-content border-box"}), 
                                React.createElement("input", {type: "text", ref: "right", className: "offsets-widget__layout-input offsets-widget__layout-input--right", onChange: this.handleChange, onKeyDown: this.handleInput, value: this.state.right}), 
                                React.createElement("br", null), 
                                React.createElement("input", {type: "text", ref: "bottom", className: "offsets-widget__layout-input offsets-widget__layout-input--bottom", onChange: this.handleChange, onKeyDown: this.handleInput, value: this.state.bottom})
                            )
                        )
                    )
                )
...
var DimensionInput = React.createClass({displayName: "DimensionInput",
    ...
    "render" : function() {
        ...
        return (
            React.createElement("div", {className: "input-widget cf"}, 
                React.createElement("span", {className: "input-widget__label"}, label), 
                React.createElement("input", {id: inputId, ref: "input", onChange: this.handleChange, className: "input-widget__value", type: "text", value: value}), 
                React.createElement("span", {className: "input-widget__unit"}, "px")
            )
        );
    }
});
...
var FiltersSidebar = React.createClass({displayName: "FiltersSidebar",
    "render" : function() {
        ...
        return (
            React.createElement("section", {className: "tool-panel"}, 
...
var ImagePreview = React.createClass({displayName: "ImagePreview",
    ...
    "render" : function() {
        ...
        return (
            React.createElement("section", {className: "image-preview__wrapper"}, 
              React.createElement("div", {className: "image-preview"}, 
                React.createElement("img", {className: "image-preview__generated " + displayClass, src: this.props.imgSrc, title: ""}), 
                React.createElement("canvas", {className: "image-preview__generator hidden"})
              )
            )
        );
    }
...
var ImageUploader = React.createClass({displayName: "ImageUploader",
    ...
    "render" : function() {
        ...
        return (
            React.createElement("div", {className: "image-upload " + displayStatus}, 
                React.createElement("form", null, 
                    React.createElement("label", {className: "image-upload__button"}, 
                        React.createElement("input", {type: "file", className: "image-upload__input", onChange: this.handleUpload}), 
...
var OriginalDimensionsWidget = React.createClass({displayName: "OriginalDimensionsWidget",
    "render" : function() {
        ...
        return (
            React.createElement("section", {className: "tool-panel__widget"}, 
                React.createElement("div", {className: "tool-panel__header"}, 
                  React.createElement("p", {className: "tool-panel__title"}, "Original Image Properties")
                ), 
                React.createElement("div", {className: "tool-panel__body"}, 
                  React.createElement("div", {className: "tool-panel__content cf"}, 
                    React.createElement("div", {className: "property pull-left"}, 
                      React.createElement("span", {className: "property__label pull-left"}, "Width: "), 
                      React.createElement("span", {className: "property__value pull-left"}, original.width), 
                      React.createElement("span", {className: "property__unit pull-left"}, "px")
                    ), 
                    React.createElement("span", {className: "property__seperator pull-left"}, ", "), 
                    React.createElement("div", {className: "property pull-left"}, 
                      React.createElement("span", {className: "property__label pull-left"}, "Height: "), 
                      React.createElement("span", {className: "property__value pull-left"}, original.height), 
                      React.createElement("span", {className: "property__unit pull-left"}, "px")
                    )
                  )
                )
...
var ResizeImageWidget = React.createClass({displayName: "ResizeImageWidget",
    ...
    "render" : function() {
        ...
        return (
            React.createElement("section", {className: "tool-panel__widget"}, 
                React.createElement("div", {className: "tool-panel__header"}, 
                    React.createElement("p", {className: "tool-panel__title"}, "Resize Image")
                ), 
                React.createElement("div", {className: "tool-panel__body"}, 
                    React.createElement("div", {className: "dimensions", className: "cf"}, 
                        React.createElement(DimensionInput, {datapoint: "width", onUserInput: this.DimValueChanged, value: dimensions.width}), 
                        React.createElement("span", {className: "dimensions__input-seperator"}, ","), 
                        React.createElement(DimensionInput, {datapoint: "height", onUserInput: this.DimValueChanged, value: dimensions.height})
                    ), 
                    React.createElement("div", {className: "aspect-ratio"}, 
                        React.createElement("input", {ref: "aspectRatioInput", id: "aspect-ratio__input", onChange: this.aspectRatioChanged, type: "checkbox", checked: isRatioFixed}), 
                        React.createElement("label", {htmlFor: "aspect-ratio__input"}, "Fix Aspect Ratio")
                    )
                )
            )
        );
